...
class PurchaseCropUser extends StatelessWidget {
  PurchaseCropUser({super.key});
  ...
  Widget build(BuildContext context) {
    final cubit = context.read<PurchaseStoreCubit>();
    return Form(
      key: context.read<PurchaseStoreCubit>().formKey,
        child: Column(
          ...
          children: [
            ...
            CustomFadeInRight(
              ...
              child: TextFormFieldApp(
                ...
                controller: context.read<PurchaseStoreCubit>().genreController,
            ...
            CustomFadeInRight(
              duration: 500,
              child: TextFormFieldApp(
                  controller: context.read<PurchaseStoreCubit>().quantityController,
                enableBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.r),
                  borderSide: BorderSide(color: Colors.grey, width: 1.w,),
                ),
            ...
            CustomFadeInRight(
              duration: 500,
              child: TextFormFieldApp(
                  controller: context.read<PurchaseStoreCubit>().priceController,
                enableBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.r),
                  borderSide: BorderSide(color: Colors.grey, width: 1.w,),
                ),
              ...
              builder: (context, state) {
                if (state is Loading) {
                  ...
                  return CustomFadeInRight(
                    ...
                    validator: (value) {
                      if (value == null) return context.translate(LangKeys.address);
                      return null;
                    },
                      ),
                  );
            ...
            CustomFadeInRight(
              duration: 500,
              child: TextFormFieldApp(
                controller: context.read<PurchaseStoreCubit>().phoneController,
                enableBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.r),
                  borderSide: BorderSide(color: Colors.grey, width: 1.w,),
                ),
