...
class ButtonSaveProfileUser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      BlocBuilder<GetProfileCubit, ProfileState>(
  ...
  void validateUpDataProfile(BuildContext context) {
    if (context.read<GetProfileCubit>().formKey.currentState!.validate()) {
      context.read<GetProfileCubit>().emitUpDataProfileState();
    }
  }
