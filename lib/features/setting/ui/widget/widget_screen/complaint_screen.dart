...
class ComplaintScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          context.translate(LangKeys.complaints),
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: TextApp(
                  text: context.translate(LangKeys.complaint),
                  style: TextStyleApp.font14black00Weight500
                      .copyWith(fontWeight: FontWeight.w500)),
            ),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 13.w, vertical: 20.h),
              child: const ComplaintsUser(),
            ),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 13.w),
              child:const ButtonComplaints(),
            ),
            const ComplaintBlocListeners(),
          ],
        ),
      ),
    );
