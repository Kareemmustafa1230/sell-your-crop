...
import 'package:sell_your_crop/features/cart/ui/screen/sell.dart';
...
import '../../features/cart/logic/cubit/sell_cubit.dart';
...
import '../../features/home_screen/logic/cubit/cities_cubit.dart';
        ...
        return MaterialPageRoute(
          builder: (_) =>
            ...
            providers: [
              ...
              BlocProvider(
                create: (context) => getIt<SellingStoreCubit>()..emitSellingStoreStates(),
              ),
            ],
            child: const SellRequest(),
          ),
        );
      case Routes.purchaseRequest:
        return MaterialPageRoute(
