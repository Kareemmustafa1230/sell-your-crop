      ...
      children: [
        ...
        InkWell(
          onTap: (){
            ...
            child: TextApp(text: context.translate(LangKeys.approvalCompany), style: TextStyleApp.font15green73Weight500.copyWith(color: ColorApp.black00,fontSize: 11.sp,decoration: TextDecoration.underline,),)),
      ],
    );
  }
}
